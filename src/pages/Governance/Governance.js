    ...
    <div className="govern">
      <div className="govern__wrapper">
        ...
        <div className="govern__text">
          <h4 className="govern__title">ORP Token</h4>
          <div className="govern__desc">
            The ORP token is a utility and governance token on the ORP protocol and it does three
            things:
            <ul className="govern__ul">
              <li>offers access to verifying data uploaded onto the protocol</li>
              <li>represents ORP DAO governance rights an</li>
              <li>mints carbon credits</li>
            </ul>
          </div>
        </div>
        <div className="govern__text">
        ...
        <div className="govern__text">
          ...
          <div className="govern__desc">
            The Open Reforestation Foundation is a nonprofit entity in charge of managing the growth
            and progressive decentralization of ORP. The ORP foundation is responsible for growing
            the ORP ecosystem to be self-sustaining and autonomously run for the long-term future.
          </div>
        </div>
      </div>
    </div>
